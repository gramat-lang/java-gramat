...
public class PowersetConstruction {
    ...
    public static Machine run(NodeFactory nodeFactory, NodeSet sources, NodeSet targets, LinkList links) {
        return new PowersetConstruction(nodeFactory).run(sources, targets, links);
    }
    ...
    private PowersetConstruction(NodeFactory nodeFactory) {
            ...
            if (control.add(oldSources.getId())) {
                ...
                for (var pattern : patterns) {
                    ...
                    if (!oldLinkPatterns.isEmpty()) {
                        ...
                        applyOperations(newLink, oldLinkPatterns);
